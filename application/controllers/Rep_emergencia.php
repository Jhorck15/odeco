...
class Rep_emergencia extends CI_Controller {
 

    public function __construct(){
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('Pdf_emergencia');
        $this->load->model('Rep_emergencia_model', 'rep_emergencia_model');
    ...
    public function con_salto($cod_reclamo){
        ...
        $id_deuda = $this->rep_emergencia_model->get_deudas($cod_reclamo);        
    ...
    public function prueba($cod_reclamo){
       $reporte = $this->rep_emergencia_model->get_reporte_detalle($cod_reclamo);
        print_r($reporte);
    ...
    public function reporte($cod_reclamo)
    {
        ...
        $data = $this->rep_emergencia_model->get_reporte($cod_reclamo);
        $reporte = $this->rep_emergencia_model->get_reporte_detalle($cod_reclamo);
        $datoabonado = $reporte->id_abonado;
        $id_abonado = $this->rep_emergencia_model->get_abonado($datoabonado);
        $dato = $reporte->id_funcionario;
        $id_func = $this->rep_emergencia_model->get_datosfunc($dato);
        $dato_d = $this->rep_emergencia_model->get_datosDeuda($cod_reclamo);
    ...
    //     curl_close($ch);       
        ...
        ob_start();
        // require('pdf.php');
        $this->pdf = new Pdf_emergencia('letter');
         ...
         */
        $this->pdf->SetTitle("ELAPAS - CENTRO DE EMERGENCIA");
