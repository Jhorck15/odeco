<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">Lista de Emergencias</h5>
		<a href="<?php echo base_url('cemergencia') ?>"><button class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Añadir Emergencia</button></a>
...
<script type="text/javascript">
   ...
   //  // 			$('#myInput').val( json.lastInput );
	...
	//        // "searching"  false,
			...
			"ajax": {
		            url: "<?php echo site_url('ccentro/lista')?>",	
		            type: "POST",
	    ...
	    $("select").change(function(){
	        ...
	        $(this).next().empty();
		 	...
		 	function makeAjaxRequest() {
			    ...
			    $.ajax({
			        url : '<?php echo site_url('ccentro/searchh')?>',
			        type : 'get',
			        data : parametros,
			        // beforeSend: function(){
			...
			function funcionario()
			{
			    ...
			    $('.help-block').empty(); 
			     ...
			     $.ajax({
			         ...
			         url: "<?php echo site_url('ccentro/datos_user')?>/",
			         type:  "GET",
			         dataType : "JSON",
    ...
    //   			$('#modalContainer').on('show', function () {
   	// 				$('input:text:visible:first').focus();
			...
			function edit_inspectorr(id)
			{
			    ...
			    $.ajax({
			        url:  "<?php echo site_url('ccentro/ajax_editt')?>/" + id,
			        type: "GET",
			        dataType: "JSON",
			        success: function(data)
			        {
			...
			function guardar()
			{
			    ...
			    if(save_method == 'add') {
			        url = "<?php echo site_url('ccentro/ajax_adicionar')?>/" + id;
			    } 
			    // else {
			...
			function delete_person(id)
			{
			    if(confirm('Are you sure delete this data?'))
			    {
			        ...
			        $.ajax({
			            url :  "<?php echo site_url('ccentro/ajax_delete')?>/"+id,
			            type :  "POST",
			            dataType : "JSON",
			            success : function(data)
			            {
			...
			function modificar_seguimiento_reclamo(){
				...
				$.ajax({
					url: '<?php echo base_url("ccentro/actualizar_inspeccion_error") ?>',
					type: 'POST',
					dataType: 'JSON',
					data: {id_reclamo: id, estado: 0},
				})
				.done(function() {
			...
			$.get('<?php echo base_url('ccentro/listainspectorr') ?>', function(data) {
					// alert(data);
				var fr = $.parseJSON(data);
			...
			$.get('<?php echo base_url('ccentro/datos_user') ?>', function(data) {
				// alert(data);
				var fr = $.parseJSON(data);
