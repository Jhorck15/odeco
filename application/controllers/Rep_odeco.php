...
class Rep_odeco extends CI_Controller {
    ...
    public function prueba($cod_reclamo){
        ...
        // $inspec = $this->rep_odeco_model->get_datos_ins(316);
    ...
    public function reporte($cod_reclamo)
    {
        ...
        // $datos = $this->con_salto($cod_reclamo);'2018-03-13 15:20:55'
        // $id_deuda = $this->rep_reclamo_model->get_deudas($cod_reclamo);        
        // $url = 'http://localhost/poseidon/cob_ventas/adeudadas/'.$id_deuda->id.'.json';
        // print_r($datos);
    ...
    //     curl_close($ch);       
        ...
        $this->pdf->Cell(100,50,'',1,0,'L',true);
        $this->pdf->setXY(10,143);
        $this->pdf->Cell(195,15,'',1,0,'L',true);
        // $this->pdf->SetFont('Arial', 'B',8);
        $this->pdf->setXY(10,27);
        ...
        $this->pdf->Cell(109,35,'',1,0,'L');
        $this->pdf->setXY(120,108);
        $this->pdf->Cell(85,35,'',1,0,'L');
        $this->pdf->setXY(120,125);
        $this->pdf->Cell(85,8,'',1,0,'L');
        $this->pdf->setXY(10,158);
        $this->pdf->Cell(65,48,'',1,0,'L');
        $this->pdf->setXY(75,158);
        $this->pdf->Cell(65,48,'',1,0,'L');
        $this->pdf->setXY(140,158);
        $this->pdf->Cell(65,48,'',1,0,'L');
        $this->pdf->setXY(110,211);
        $this->pdf->Cell(95,50,'',1,0,'L');
        ...
        $this->pdf->setXY(120,111);
        $this->pdf->Cell(20,7,utf8_decode('Detalle:'),0,0,'L');
        $this->pdf->setXY(120,123);
        ...
        $this->pdf->setXY(11,73);
        $this->pdf->MultiCell(137,3,utf8_decode($reporte->motivo),0,'L',false);
        ...
        $this->pdf->Cell(45,7,utf8_decode('Tamaño de vivienda:.............. '),0,0,'R');
        $this->pdf->setXY(40,113);
        $this->pdf->Cell(10,7,utf8_decode($inspec->tamaniovivienda),0,0,'L');
        ...
        $this->pdf->Cell(10,7,utf8_decode($inspec->numbanio),0,0,'R');
        ...
        $this->pdf->Cell(45,7,utf8_decode('Estado de tanques de baño:............... '),0,0,'R');
        $this->pdf->setXY(92,113);
        $this->pdf->Cell(20,7,utf8_decode($inspec->estadotanquebanio),0,0,'L');
        $this->pdf->setXY(60,119);
        $this->pdf->Cell(45,7,utf8_decode('Presión de agua en la zona:............... '),0,0,'R');
        $this->pdf->setXY(94,119);
        $this->pdf->Cell(10,7,utf8_decode($inspec->presionaguazona),0,0,'C');
        ...
        $this->pdf->Image('assets/images/ela/check.png',125,128,3,0);
        $this->pdf->Image('assets/images/ela/check.png',162,128,3,0);
        $this->pdf->setXY(126,127);
