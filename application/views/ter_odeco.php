<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Imprimir</h5>
...
<script type="text/javascript">
   ...
   //  					alert('dasdasd');
	  	 ...
	  	 table = $('#t_reclamo').DataTable({ 
			...
			"ajax": {
		            url: "<?php echo site_url('cterm_odeco/lista')?>",	
		            type: "POST",
	...
	//         // botones 
	   ...
	   // $('#t_reclamo').dataTable()._fnAjaxUpdate();
		...
		function edit_inspectorr(id)
		{
			...
			var x=parseInt((window.screen.width/2)-(anchura/2));
			// alert(id);
	 		window.open("<?php echo site_url('Rep_odeco/reporte/')?>" + id, "Reporte reclamo", "directories=no, location=no, menubar=no, scrollbars=yes, statusbar=no, tittlebar=yes, width=acnhura, height=altura, top=y,left=x");
