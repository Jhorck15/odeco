...
class Form_ins_tecnicados_model extends CI_Model {

	var $table = 'forinscuatrodos';
	var $column = array('fechaforinspcuatrodos', 'obsacometida', 'septicos', 'servidumbres', 'informe', 'id_reclamo'); //set column field database for order and search
	var $order = array('id_forinscuatrodos' => 'desc'); // default order 
	...
	{
		$this->db->insert('formularioinscuatrodos_archivo', $data);
	}
