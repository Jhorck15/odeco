	...
	<form id="form_inspeccion">
	    <div class="panel-body">
	    	<div class="row">
				...
				<div class="col-md-4">
	    			<div class="form-group">
						<label>Fuga en el alcantarillado sanitario :</label>
	                	<select name="fugaalcanta" id="faltaagua" class="form-control">
	                		<option value="">Seleccione...</option>
	                		<option value="Obstrucción de red matriz">Obstrucción de red matriz</option>
	                		<option value="Obstrucción de cámaras de inspección">Obstrucción de cámaras de inspección</option>
	                		<option value="Por trabajo de municipio">Por trabajo de municipio</option>
	                		<option value="Por trabajo de terceros">Por trabajo de terceros</option>
				...
				<div class="col-md-4">
	    			<div class="form-group">
						<label>Obstrucción acometida del alcantarillado: </label>
	                	<select name="obsacometida" id="faltaagua" class="form-control">
	                		<option value="">Seleccione...</option>
	                		<option value="Mal estado de tuberías">Mal estado de tuberías</option>
	                		<option value="Mal estado de cámaras de inspección">Mal estado de cámaras de inspección</option>
	                		<option value="Obstrucción en los sumideros pluviales">Obstrucción en los sumideros pluviales</option>
	                		<option value="No">No</option>
						</select>
					</div>
				</div>
			...
			<div class="row">
	    		<div class="col-md-4">
	    			<div class="form-group">
	    				<label>Tanques sépticos: </label>
	    				<select name="septicos" id="faltaagua" class="form-control">
	                		<option value="">Seleccione...</option>
	                		<option value="Rebalse por saturación">Rebalse por saturación</option>
	                		<option value="Sedimentación">Sedimentación</option>
	                		<option value="No">No</option>
	                	</select>					
					</div>
				</div>
				<div class="col-md-4">
	    			<div class="form-group">
	    				<label>Servidumbres domiciliarios de alcantarillado: </label>
	                	<select name="servidumbres" id="faltaagua" class="form-control">
	                		<option value="">Seleccione...</option>
	                		<option value="Humedad y/o filtración de inmueble colindante">Humedad y/o filtración de inmueble colindante</option>
	                		<option value="No">No</option>
	                	</select>	
					</div>
				</div>				
			...
			<div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Informe: </label>
                        <textarea id="informes" name ="informes" rows="3" class="form-control elastic"></textarea>
                    </div>
                </div>
            </div>
	...
	<table id="tableformulario" class="table datatable-basic dataTable no-footer">
		<thead>
			<tr>
	        	<!-- <th>Nº</th> -->
	            <th>Fec. Inspección</th>
	            <th>Fuga alcantarillado</th>
	            <th>Obstruido de Acometida</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		table = $('#tableformulario').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('form_ins_tecnicados/ajax_list')?>",
	            "type": "POST"
	        },
	...
	function cargarreclamo() {
		$.ajax({
			url: '<?php echo base_url('form_ins_tecnicados/cargar_reclamo') ?>',
			type: 'GET',
			dataType: 'JSON',
	...
	$("#form_inspeccion").on("submit", function(event) {
		...
		if($('#btnSave').text().trim() == 'Guardar') {
	        url = "<?php echo base_url('form_ins_tecnicados/ajax_add_inspection')?>";
	    } else {
	        url = "<?php echo base_url('form_ins_tecnicados/ajax_update_inspection')?>";
	    }
