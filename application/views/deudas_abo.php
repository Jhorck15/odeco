<div class="panel panel-flat bg-danger-300">
	<div class="panel-heading">
		<h5 class="panel-title">Consulta de pagos</h5><p> </p>
    	...
    	<div class="row">
			...
			<div class="col-md-6">
					<div  class="form-group"><div> </div> <div><p></p> </div><div class="color:white;"> jhorck</div> <div> </div>
   ...
   //  // 			$('#myInput').val( json.lastInput );
	...
	//        // "searching"  false,
			...
			"language": {
	            ...
	            "loadingRecords":  "No hay pagos pendientes...",
	     		"processing" :     "Procesando...",
	            "sSearch" :      "Buscar ",
            	"ZeroRecords":  "No se encontraron resultados",
	            "infoEmpty":  "No hay pagos pendientes",
			...
			"ajax": {
		            url: "<?php echo site_url('cdeudas_abo/searchh')?>",	
		            type: "POST",
		            data: parametros,
