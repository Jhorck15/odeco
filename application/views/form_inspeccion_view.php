	    	...
	    	<div class="row">
	    		...
	    		<div class="col-md-4">
	    			<div class="form-group">
	                	...
	                	<input type="text" class="form-control" id="fechainspeccion" name="fechainspeccion">
					</div>
				</div>
				<div class="col-md-4">
	    			<div class="form-group">
						<label>Tamaño de la vivienda:</label>
	                	<input type="text" class="form-control" name="tamaniovivienda">
					</div>
				</div>
				<div class="col-md-4">
	    			<div class="form-group">
						<label>Número de habitantes: </label>
	                	<input type="text" class="form-control" name="numerohabitantes" placeholder="">
					</div>
				</div>
			</div>
			<div class="row">
	    		<div class="col-md-4">
	    			<div class="form-group">
						...
						<select name="calibrado" id="calibrado" class="form-control">
				...
				<div class="col-md-4">
	    			<div class="form-group">
						<label>Ubicacion del medidor: </label>
	                	<input type="text" class="form-control format-phone-fijo" name="ubicacionmedidor" placeholder="">
					</div>
				</div>
				<div class="col-md-4">
	    			<div class="form-group">
						<label>Estado del tanque de baño: </label>
	                	<input type="text" class="form-control format-phono-celular" name="estadotanquebanio" placeholder="">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
	    			<div class="form-group">
						<label>Presión de agua en la zona: (m/seg)</label>
	                	<input type="text" class="form-control" name="presionzona" placeholder="99">
					</div>
				</div>
	    		<div class="col-md-4">
	    			<div class="form-group">
				...
				<div class="col-md-4">
	    			<div class="form-group">
						<label>Filtracion interna: </label>
	                	<select name="filtracioninterna" id="filtracioninterna" class="form-control">
	                		<option value="">Seleccione...</option>
	                		<option value="SI">SI</option>
	                		<option value="NO">NO</option>
						</select>
			...
			<div class="row">
				<div class="col-md-4">
	    			<div class="form-group">
	                	...
	                	<input type="text" class="form-control " name="marcamedidor" placeholder="">
					</div>
				</div>
	    		<!-- <div class="col-md-4">
	    			<div class="form-group">
						<label>Descripcion de Medidor: </label>
	                	<input type="text" class="form-control " name="descripcionmedidor" placeholder="">
					</div>
				</div> -->
				<div class="col-md-4">
	    			<div class="form-group">
			...
			<div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="descripcionmedidor" name ="descripcionmedidor" rows="3" class="form-control elastic"></textarea>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		table = $('#tableformulario').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('form_inspeccion/ajax_list')?>",
	            "type": "POST"
	        },
	...
	function cargarreclamo() {
		$.ajax({
			url: '<?php echo base_url('form_inspeccion/cargar_reclamo') ?>',
			type: 'GET',
			dataType: 'JSON',
	...
	$("#form_inspeccion").on("submit", function(event) {
		...
		if($('#btnSave').text().trim() == 'Guardar') {
	        url = "<?php echo base_url('form_inspeccion/ajax_add_inspection')?>";
	    } else {
	        url = "<?php echo base_url('form_inspeccion/ajax_update_inspection')?>";
	    }
			...
			$.ajax({
				...
				success: function(d) {
					if (d.status) {
						...
						reload_table();
						window.location.href='<?php echo base_url() ?>form_inspecciondos/'; 
	...
	function edit_forminscripcion(id)
	{
	    ...
	    $.ajax({
	        url : "<?php echo site_url('form_inspeccion/ajax_edit_forminspeccion/')?>" + id,
	        type: "GET",
	        dataType: "JSON",
	        success: function(dataforminspecc)
	        {
	            $('[name="id_formularioinspeccion"]').val(dataforminspecc.id_formularioinspeccion);
	            $('[name="fechainspeccion"]').val(dataforminspecc.fechaforminspeccion);
	            $('[name="tamaniovivienda"]').val(dataforminspecc.tamaniovivienda);
	            $('[name="numerohabitantes"]').val(dataforminspecc.numerohabitantes);
	            $('[name="calibrado"]').val(dataforminspecc.calibrado);
	            $('[name="ubicacionmedidor"]').val(dataforminspecc.ubicacionmedidor);
	            $('[name="estadotanquebanio"]').val(dataforminspecc.estadotanquebanio);
	            $('[name="presionzona"]').val(dataforminspecc.presionaguazona);
	            $('[name="piscina"]').val(dataforminspecc.piscina);
	            $('[name="filtracioninterna"]').val(dataforminspecc.filtracioninterna);
	            $('[name="marcamedidor"]').val(dataforminspecc.marcamedidor);
	            $('[name="descripcionmedidor"]').val(dataforminspecc.descripcioninformeinspeccion);
				...
				$.post('<?php echo base_url('form_inspeccion/get_subreclamo') ?>',
				...
				$.post('<?php echo base_url("form_inspeccion/get_archivos") ?>', {id_archivo: dataforminspecc.id_formularioinspeccion}, function(datos, textStatus, xhr) {
