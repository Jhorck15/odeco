...
class Rep_odeco extends CI_Controller {
    ...
    //     curl_close($ch);       
        ...
        $this->pdf->setXY(56,113);
        $this->pdf->Cell(45,7,utf8_decode('Estado tanques de baño:............... '),0,0,'R');
